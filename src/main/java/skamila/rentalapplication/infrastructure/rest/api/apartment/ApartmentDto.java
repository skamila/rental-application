...
class ApartmentDto {
    ...
    public ApartmentDto(String ownerId, String street, String postalCode, String houseNumber, String apartmentNumber, String city, String country, String description, Map<String, Double> roomsDefinition) {
